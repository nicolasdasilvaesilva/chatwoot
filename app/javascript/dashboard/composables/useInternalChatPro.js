 ...
 * so Pro features remain locked. The Pro repo adds this flag and manages
 * it via subscription hub, unlocking features automatically.
 *
 * Indica Fácil exception: polls are unlocked on Free. Keep this in sync with
 * the backend gate in `InternalChat::Limits.polls_enabled?`.
 */
